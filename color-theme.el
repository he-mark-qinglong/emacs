...
emacs*Foreground:		Wheat"
  ...
  (let ((color-theme-cumulative t))
	...
	(view-highlight-face . highlight))
       ...
       (font-lock-variable-name-face ((t (:bold t :foreground "cyan"))))
       ;;(font-lock-variable-name-face ((t (:bold t :foreground "orange red"))))
       ...
       (modeline ((t (:background "#1c230f" :foreground "wheat"))))
       ;;(modeline-buffer-id ((t (:background "DarkOliveGreen" :foreground "beige"))))
       (modeline-buffer-id ((t (:background "#1c230f" :foreground "beige"))))
       ;;(modeline-mousable ((t (:background "DarkOliveGreen" :foreground "yellow green"))))
       (modeline-mousable ((t (:background "#1c230f" :foreground "yellow green"))))
       ;;(modeline-mousable-minor-mode ((t (:background "DarkOliveGreen" :foreground "wheat"))))
       (modeline-mousable-minor-mode ((t (:background "#1c230f" :foreground "wheat"))))
       ;;(region ((t (:background "dark cyan" :foreground "cyan"))))
       (region ((t (:background "orange4" :foreground "white"))))
